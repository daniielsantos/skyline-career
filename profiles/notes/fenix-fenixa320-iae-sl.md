# FenixA320 IAE SL — discovery

**In-sim title (example):** `FenixA320 IAE SL`  
**Match title:** `FenixA320 IAE SL`  
**ICAO (SimBrief type):** `A320`  
**Publisher:** `fenix`  
**Stations:** 16  
**Profile:** `fenix/fenixa320-iae-sl@1.0.0`
...
- `profiles/examples/fenix-fenixa320-iae-sl.json`
