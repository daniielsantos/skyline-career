...
- **Port FBO (2026-09-06):** Phase 0–10 shipped — lease-out/crew **off**; desk auto-buy; stevedore; Base perks; Scout bridge+Demand+Haul; Port shuttle. Spec: [`24-port-fbo.md`](./24-port-fbo.md).
