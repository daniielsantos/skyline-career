...
**Doc 2026-09-22 (d):** Crew Roster **Live** — Watch uploads; OD + trail. **(e–o)** … **(p)** fase Live = mesma do footer SimBridge (não OFP compliance). **(x–y)** detach + pipe hygiene sem uplink. **Soft uplink Watch→VPS shipped** (tick sample only).
