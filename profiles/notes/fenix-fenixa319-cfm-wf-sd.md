# FenixA319 CFM WF SD — discovery

**In-sim title (example):** `FenixA319 CFM WF SD`  
**Match title:** `FenixA319 CFM WF SD`  
**ICAO (SimBrief type):** `A319`  
**Publisher:** `fenix`  
**Stations:** 16  
**Profile:** `fenix/fenixa319-cfm-wf-sd@1.0.0`
...
- `profiles/examples/fenix-fenixa319-cfm-wf-sd.json`
