# ATR 72-600 Highline 04 — discovery

**In-sim title (example):** `ATR 72-600 Highline 04`  
**Match title:** `ATR 72-600 Highline 04`  
**ICAO (SimBrief type):** `AT76`  
**Publisher:** `microsoft`  
**Stations:** 11  
**Profile:** `microsoft/atr-72-600-highline-04@1.0.0`
...
- `profiles/examples/microsoft-atr-72-600-highline-04.json`
