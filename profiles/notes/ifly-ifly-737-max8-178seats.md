# iFly 737-MAX8 (178Seats) — discovery

**In-sim title (example):** `iFly 737-MAX8 (178Seats)`  
**Match title:** `iFly 737-MAX8 (178Seats)`  
**ICAO (SimBrief type):** `B38M`  
**Publisher:** `ifly`  
**Stations:** 11  
**Profile:** `ifly/ifly-737-max8-178seats@1.0.0`
...
- `profiles/examples/ifly-ifly-737-max8-178seats.json`
- Market SKU: `ifly-737-max-8` (OFP pack `profiles/ofp/ifly-737-max-8.json`); SimBrief seat row via live title.
