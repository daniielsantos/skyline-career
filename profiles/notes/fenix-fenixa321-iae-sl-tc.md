# FenixA321 IAE SL TC — discovery

**In-sim title (example):** `FenixA321 IAE SL TC`  
**Match title:** `FenixA321 IAE SL TC`  
**ICAO (SimBrief type):** `A321`  
**Publisher:** `fenix`  
**Stations:** 16  
**Profile:** `fenix/fenixa321-iae-sl-tc@1.0.0`
...
- `profiles/examples/fenix-fenixa321-iae-sl-tc.json`
