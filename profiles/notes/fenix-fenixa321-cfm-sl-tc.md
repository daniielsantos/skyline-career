# FenixA321 CFM SL TC — discovery

**In-sim title (example):** `FenixA321 CFM SL TC`  
**Match title:** `FenixA321 CFM SL TC`  
**ICAO (SimBrief type):** `A321`  
**Publisher:** `fenix`  
**Stations:** 16  
**Profile:** `fenix/fenixa321-cfm-sl-tc@1.0.0`
...
- `profiles/examples/fenix-fenixa321-cfm-sl-tc.json`
