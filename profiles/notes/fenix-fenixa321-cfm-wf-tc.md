# FenixA321 CFM WF TC — discovery

**In-sim title (example):** `FenixA321 CFM WF TC`  
**Match title:** `FenixA321 CFM WF TC`  
**ICAO (SimBrief type):** `A321`  
**Publisher:** `fenix`  
**Stations:** 16  
**Profile:** `fenix/fenixa321-cfm-wf-tc@1.0.0`
...
- `profiles/examples/fenix-fenixa321-cfm-wf-tc.json`
