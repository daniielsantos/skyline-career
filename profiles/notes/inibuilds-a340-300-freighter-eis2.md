# A340-300 Freighter EIS2 — discovery

**In-sim title (example):** `A340-300 Freighter EIS2`  
**Match title:** `A340-300 Freighter EIS2`  
**ICAO (SimBrief type):** `A343`  
**Publisher:** `inibuilds`  
**Stations:** 13  
**Profile:** `inibuilds/a340-300-freighter-eis2@1.0.0`
...
- `profiles/examples/inibuilds-a340-300-freighter-eis2.json`
