...
- Uplink Crew Live a partir de Watch/probe/Preflight ficou **removido** (2026-09-22). API/mapa Live podem existir; telemetria desktop **não** se reacopla sem desenho novo e confirmação explícita.
