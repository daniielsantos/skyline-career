# LEARJET 35A CARGO LONG RANGE — discovery

**In-sim title (example):** `LEARJET 35A CARGO LONG RANGE`  
**Match title:** `LEARJET 35A CARGO LONG RANGE`  
**ICAO (SimBrief type):** `LJ35`  
**Publisher:** `flysimware`  
**Stations:** 6  
**Profile:** `flysimware/learjet-35a-cargo-long-range@1.0.0`
...
- `profiles/examples/flysimware-learjet-35a-cargo-long-range.json`
