# ATR 72-600 Freighter — discovery

**In-sim title (example):** `ATR 72-600 Freighter`  
**Match title:** `ATR 72-600 Freighter`  
**ICAO (SimBrief type):** `AT76`  
**Publisher:** `microsoft`  
**Stations:** 11  
**Profile:** `microsoft/atr-72-600-freighter@1.0.0`
...
- `profiles/examples/microsoft-atr-72-600-freighter.json`
