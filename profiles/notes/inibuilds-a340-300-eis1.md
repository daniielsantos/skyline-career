# A340-300 EIS1 — discovery

**In-sim title (example):** `A340-300 EIS1`  
**Match title:** `A340-300 EIS1`  
**ICAO (SimBrief type):** `A343`  
**Publisher:** `inibuilds`  
**Stations:** 13  
**Profile:** `inibuilds/a340-300-eis1@1.0.0`
...
- `profiles/examples/inibuilds-a340-300-eis1.json`
