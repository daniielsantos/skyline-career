...
- **Crew fee $/nm floor (2026-08-30):** ainda **30%** do frete (`CONTRACT_PILOT_FEE_FRAC`); Light GA **1.4 $/nm** · Light TP **1.65 $/nm** (`career-contract-pilot-fee.ts` + mirror UI) — haul longo com pay fino não paga menos que ferry curto. Abaixo do ferry Hangar (~2.1–2.5). Sem `CARGO_FLOW_BALANCE`.
