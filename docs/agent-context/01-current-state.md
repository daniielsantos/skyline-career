...
`main` **0385647d** / desktop **0.3.280** shipped: Promote iFly 737 MAX 8 and MAX 8200 to Market with SimBrief seat rows. Release: [v0.3.280](https://github.com/daniielsantos/skyline-career/releases/tag/v0.3.280).
...
`main` **9b8d1d3a** / desktop **0.3.263** shipped: Clarify Freights matching count and drop Contracts ferry shortcut. Release: [v0.3.263](https://github.com/daniielsantos/skyline-career/releases/tag/v0.3.263).
...
`main` **77d85c4f** / desktop **0.3.249** shipped: Tighten Hauls column gaps so the aircraft select fits beside Prepare. Release: [v0.3.249](https://github.com/daniielsantos/skyline-career/releases/tag/v0.3.249).
...
`main` **dedf6ab** / desktop **0.3.135** shipped: Fix new-account Away banner, sticky pilot name, and host wait retry. Release: [v0.3.135](https://github.com/daniielsantos/skyline-career/releases/tag/v0.3.135).
...
`main` **f0626cc** / desktop **0.3.125** shipped: Densify Asia Wave C to ~400 hubs (seed 2281). Release: [v0.3.125](https://github.com/daniielsantos/skyline-career/releases/tag/v0.3.125).


`main` **af4a7db** / desktop **0.3.124** shipped: Densify Asia Wave B to ~350 hubs (seed 2231). Release: [v0.3.124](https://github.com/daniielsantos/skyline-career/releases/tag/v0.3.124).
...
`main` **0029bc9** / desktop **0.3.121** shipped: Densify EU-1 Wave 2 to ~300 hubs and add MENA/SE-Asia pulse lenses. Release: [v0.3.121](https://github.com/daniielsantos/skyline-career/releases/tag/v0.3.121).
...
| Versão | Tag | Notas |
|--------|-----|--------|
| **0.3.61** (latest) | [v0.3.61](https://github.com/daniielsantos/skyline-career/releases/tag/v0.3.61) | SP\|MP play gate + Settings; fleet registration migrate; :8788 |
| **0.3.60** | [v0.3.60](https://github.com/daniielsantos/skyline-career/releases/tag/v0.3.60) | Default API :8788; Docker-safe port reclaim |
