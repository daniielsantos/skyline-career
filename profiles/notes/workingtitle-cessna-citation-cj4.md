...
- **S5 (BAGGAGE 01)** is a ghost for inject: weight sticks briefly then drops. Roles pack marks it `service`; cargo uses S3/S4/S6 at **750 lb** each (no crew-seat overflow — pilots sit forward and pull CG FWD).
