...
export const US_MW_DENSIFY_HUBS: readonly DensifyHub[] = [
  ...
  {
    icao: 'KDIK',
    name: 'Dickinson Theodore Roosevelt',
    region: 'US-MW',
    hubTier: 'spoke',
    lat: 46.7974,
    lon: -102.802,
  ...
  {
    icao: 'KFNT',
    name: 'Flint Bishop International',
    region: 'US-MW',
    hubTier: 'spoke',
    lat: 42.9654,
    lon: -83.7435,
...
export const US_SE_DENSIFY_HUBS: readonly DensifyHub[] = [
  ...
  {
    icao: 'KMLB',
    name: 'Melbourne Orlando International',
    region: 'US-SE',
    hubTier: 'spoke',
    lat: 28.1028,
    lon: -80.6453,
...
export const US_NE_DENSIFY_HUBS: readonly DensifyHub[] = [
  ...
  {
    icao: 'KSBY',
    name: 'Salisbury-Ocean City Wicomico',
    region: 'US-NE',
    hubTier: 'spoke',
    lat: 38.3402,
    lon: -75.5103,
