# ATR 72-600 Highline 01 — discovery

**In-sim title (example):** `ATR 72-600 Highline 01`  
**Match title:** `ATR 72-600 Highline 01`  
**ICAO (SimBrief type):** `AT76`  
**Publisher:** `microsoft`  
**Stations:** 11  
**Profile:** `microsoft/atr-72-600-highline-01@1.0.0`
...
- `profiles/examples/microsoft-atr-72-600-highline-01.json`
