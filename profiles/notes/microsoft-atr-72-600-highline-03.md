# ATR 72-600 Highline 03 — discovery

**In-sim title (example):** `ATR 72-600 Highline 03`  
**Match title:** `ATR 72-600 Highline 03`  
**ICAO (SimBrief type):** `AT76`  
**Publisher:** `microsoft`  
**Stations:** 11  
**Profile:** `microsoft/atr-72-600-highline-03@1.0.0`
...
- `profiles/examples/microsoft-atr-72-600-highline-03.json`
