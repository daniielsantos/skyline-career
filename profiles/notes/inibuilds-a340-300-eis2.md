# A340-300 EIS2 — discovery

**In-sim title (example):** `A340-300 EIS2`  
**Match title:** `A340-300 EIS2`  
**ICAO (SimBrief type):** `A343`  
**Publisher:** `inibuilds`  
**Stations:** 13  
**Profile:** `inibuilds/a340-300-eis2@1.0.0`
...
- `profiles/examples/inibuilds-a340-300-eis2.json`
