...
/**
 * Seed the career cargo world: Americas hubs (SA + Central America + Caribbean +
 * US/CA/MX), with asymmetric production/consumption so ticks create explainable lanes.
 */
