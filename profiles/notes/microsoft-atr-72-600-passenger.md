# ATR 72-600 Passenger — discovery

**In-sim title (example):** `ATR 72-600 Passenger`  
**Match title:** `ATR 72-600 Passenger`  
**ICAO (SimBrief type):** `AT76`  
**Publisher:** `microsoft`  
**Stations:** 11  
**Profile:** `microsoft/atr-72-600-passenger@1.0.0`
...
- `profiles/examples/microsoft-atr-72-600-passenger.json`
