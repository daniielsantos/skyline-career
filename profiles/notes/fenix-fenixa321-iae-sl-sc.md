# FenixA321 IAE SL SC — discovery

**In-sim title (example):** `FenixA321 IAE SL SC`  
**Match title:** `FenixA321 IAE SL SC`  
**ICAO (SimBrief type):** `A321`  
**Publisher:** `fenix`  
**Stations:** 16  
**Profile:** `fenix/fenixa321-iae-sl-sc@1.0.0`
...
- `profiles/examples/fenix-fenixa321-iae-sl-sc.json`
