...
import {
  ...
  VN_CAREER_HUBS,
  buildVnFeederCorridors,
} from './career-vn-hubs.js';
import {
  assertMyCareerHubCatalog,
  MY_CAREER_HUBS,
  buildMyFeederCorridors,
} from './career-my-hubs.js';
import {
...
import {
  ...
  CN_CAREER_HUBS,
  buildCnFeederCorridors,
} from './career-cn-hubs.js';
import {
  assertJpCareerHubCatalog,
  JP_CAREER_HUBS,
  buildJpFeederCorridors,
} from './career-jp-hubs.js';
import {
...
import {
  ...
  FJ_CAREER_HUBS,
  buildFjFeederCorridors,
} from './career-fj-hubs.js';
import {
  assertPgCareerHubCatalog,
  PG_CAREER_HUBS,
  buildPgFeederCorridors,
} from './career-pg-hubs.js';
import {
...
export {
  ...
  DYNAMIC_INTL_REGIONAL_MAX_NM,
  DYNAMIC_INTL_REGIONAL_SHARE_MIN,
...
/** International feeder ceiling — lets light jets use their ~2,000 nm range. */
export const INTL_LIGHT_JET_LTL_MAX_NM = 2_000;
/**
...
const CAREER_CARGO_CORRIDORS_MANUAL: ReadonlyArray<{
  ...
  { a: 'SBRJ', b: 'SBGL', weight: 1.7 },
  { a: 'SBSP', b: 'SBGR', weight: 1.8 },
  { a: 'SBSP', b: 'SBKP', weight: 1.6 },
  { a: 'SBME', b: 'SBGL', weight: 1.4 },
  { a: 'SBSM', b: 'SBPA', weight: 1.5 },
  { a: 'SBPF', b: 'SBPA', weight: 1.4 },
  { a: 'SBKG', b: 'SBRF', weight: 1.5 },
  { a: 'SBCJ', b: 'SBBE', weight: 1.5 },
  { a: 'SBCJ', b: 'SBEG', weight: 1.4 },
  { a: 'SBAN', b: 'SBBR', weight: 1.5 },
  { a: 'SBAN', b: 'SBGO', weight: 1.4 },
  ...
  { a: 'KSTL', b: 'KORD', weight: 1.6 },
  { a: 'KSTL', b: 'KMEM', weight: 1.5 },
  { a: 'KSTL', b: 'KDFW', weight: 1.4 },
  { a: 'KPIT', b: 'KEWR', weight: 1.5 },
  { a: 'KPIT', b: 'KORD', weight: 1.5 },
  { a: 'KPIT', b: 'KATL', weight: 1.4 },
  { a: 'KDLH', b: 'KMSP', weight: 1.5 },
  { a: 'KDLH', b: 'KORD', weight: 1.4 },
  { a: 'KMDW', b: 'KORD', weight: 1.8 },
  { a: 'KCMH', b: 'KORD', weight: 1.5 },
  ...
  { a: 'KPAE', b: 'KSEA', weight: 1.6 },
  { a: 'KSCK', b: 'KSFO', weight: 1.5 },
  ...
  // Asia-11 Vietnam / Malaysia / Singapore domestic trunks
  { a: 'VVNB', b: 'VVCI', weight: 1.7 },
  { a: 'VVNB', b: 'VVDN', weight: 1.6 },
  { a: 'VVTS', b: 'VVCT', weight: 1.6 },
  { a: 'VVTS', b: 'VVDN', weight: 1.5 },
  { a: 'VVNB', b: 'VVTS', weight: 1.9 },
  { a: 'WMKK', b: 'WMKJ', weight: 1.6 },
  ...
  // Asia-13 China / Japan / Korea domestic trunks
  { a: 'ZBAA', b: 'ZSPD', weight: 1.9 },
  { a: 'ZSPD', b: 'ZSSS', weight: 1.8 },
  { a: 'ZSPD', b: 'ZGGG', weight: 1.8 },
  { a: 'ZGGG', b: 'ZGSZ', weight: 1.7 },
  { a: 'ZBAA', b: 'ZUUU', weight: 1.6 },
  { a: 'ZSPD', b: 'ZUUU', weight: 1.5 },
  { a: 'RJAA', b: 'RJTT', weight: 1.9 },
  { a: 'RJAA', b: 'RJBB', weight: 1.8 },
  { a: 'RJBB', b: 'RJFF', weight: 1.6 },
  ...
  // CN-2 China densify
  { a: 'ZBAA', b: 'ZYTX', weight: 1.7 },
  { a: 'ZYTX', b: 'ZYCC', weight: 1.5 },
  { a: 'ZYCC', b: 'ZYHB', weight: 1.5 },
  { a: 'ZBAA', b: 'ZBHH', weight: 1.4 },
  { a: 'ZSPD', b: 'ZSHC', weight: 1.7 },
  { a: 'ZSPD', b: 'ZSNJ', weight: 1.6 },
  { a: 'ZHHH', b: 'ZHCC', weight: 1.6 },
  { a: 'ZSPD', b: 'ZSNB', weight: 1.5 },
  { a: 'ZSAM', b: 'ZSFZ', weight: 1.45 },
  { a: 'ZGGG', b: 'ZGHA', weight: 1.6 },
  { a: 'ZGGG', b: 'ZGNN', weight: 1.55 },
  { a: 'ZGNN', b: 'ZJHK', weight: 1.4 },
  { a: 'ZJHK', b: 'ZJSY', weight: 1.35 },
  { a: 'ZUUU', b: 'ZUGY', weight: 1.5 },
  { a: 'ZLXY', b: 'ZLLL', weight: 1.5 },
  { a: 'ZLLL', b: 'ZLIC', weight: 1.4 },
  { a: 'ZLIC', b: 'ZWWW', weight: 1.35 },
  { a: 'ZSHC', b: 'RJAA', weight: 1.45 },
  { a: 'ZYTX', b: 'RKSI', weight: 1.4 },
  { a: 'ZGNN', b: 'VVNB', weight: 1.4 },
  { a: 'ZJHK', b: 'RCTP', weight: 1.35 },
  ...
  // RU-3 Russia densify
  { a: 'UUEE', b: 'UUWW', weight: 1.8 },
  { a: 'ULLI', b: 'ULAA', weight: 1.6 },
  { a: 'UWGG', b: 'UWKD', weight: 1.6 },
  { a: 'UWKD', b: 'UWKE', weight: 1.4 },
  { a: 'UWKD', b: 'UWUU', weight: 1.55 },
  { a: 'USSS', b: 'USPP', weight: 1.6 },
  { a: 'USSS', b: 'USCC', weight: 1.55 },
  { a: 'USSS', b: 'USTR', weight: 1.6 },
  { a: 'USTR', b: 'USRR', weight: 1.5 },
  { a: 'USRR', b: 'USNN', weight: 1.4 },
  { a: 'URRP', b: 'URKK', weight: 1.6 },
  { a: 'URKK', b: 'URSS', weight: 1.45 },
  { a: 'UWWW', b: 'URWW', weight: 1.5 },
  { a: 'URWW', b: 'URWA', weight: 1.4 },
  { a: 'URKK', b: 'URMM', weight: 1.4 },
  { a: 'UNNT', b: 'UNOO', weight: 1.6 },
  { a: 'UNNT', b: 'UNBB', weight: 1.5 },
  { a: 'UNNT', b: 'UNTT', weight: 1.45 },
  { a: 'UNKL', b: 'UIBB', weight: 1.45 },
  { a: 'UIII', b: 'UIUU', weight: 1.5 },
  { a: 'UNKL', b: 'UOOO', weight: 1.4 },
  { a: 'UHHH', b: 'UHBB', weight: 1.45 },
  { a: 'UHWW', b: 'UHSS', weight: 1.5 },
  { a: 'ULAA', b: 'ENGM', weight: 1.35 },
  { a: 'UWKD', b: 'LTFM', weight: 1.4 },
  { a: 'URKK', b: 'UGTB', weight: 1.35 },
  { a: 'UNOO', b: 'UACC', weight: 1.4 },
  { a: 'UHSS', b: 'RJCC', weight: 1.45 },
  ...
  { a: 'ZBAA', b: 'ZLXY', weight: 1.6 },
  { a: 'ZUUU', b: 'ZUCK', weight: 1.7 },
  { a: 'ZUUU', b: 'ZPPP', weight: 1.6 },
  { a: 'ZUUU', b: 'ZLXY', weight: 1.5 },
  { a: 'ZSPD', b: 'ZHHH', weight: 1.6 },
...
/** Refresh the bounded dynamic international gateway graph once per economy day. */
export function ensureInternationalLanes(world: CareerEconomyWorld): boolean {
  return ensureDynamicInternationalLanes(world);
}
...
export const FUEL_HUB_ICAOS = new Set([
  ...
  'KLAX',
  'KSEA',
  // US densify producers (regional anchors).
  'KMSP',
  'KSTL',
  'KDTW',
  'KMEM',
  ...
  'LEVC',
  'LPBJ',
  // EU-1 Wave 1 densify producers (~1 per 2–3 new hubs)
  'LFOT',
  'LFLB',
  'LFMP',
  'EDFM',
  ...
  'LPAZ',
  'EHTX',
  // EU-1 Wave 2 densify producers (~1 per 2–3 new hubs)
  'LPSJ',
  'LPMR',
  'LERS',
  'LEXJ',
  ...
  'RCYU',
  'YBCG',
  // Asia densify Wave A producers (~1 per 2–3 new hubs)
  'ZBSJ',
  'ZSWX',
  'ZGZJ',
  'ZBYC',
  ...
  'VVPB',
  'RKPD',
  // Asia densify Wave B producers (~1 per 2–3 new hubs)
  'ZBAD',
  'ZPMS',
  'ZSXZ',
  'ZYJM',
  ...
  'VVPK',
  'UACK',
  // Asia densify Wave C producers (~1 per 2–3 new hubs)
  'ZYMD',
  'ZUXC',
  'ZYYJ',
  'ZBCF',
  ...
  'NFNL',
  'NVVW',
  // Oceania densify Wave B producers (~1 per 2–3 new hubs)
  'YBTI',
  'YCCY',
  'YCFS',
  'YCMU',
...
> = {
  ...
  ...Object.fromEntries(
    VN_CAREER_HUBS.map((h) => [
      h.icao,
      { lat: h.lat, lon: h.lon, name: h.name },
    ]),
  ),
  ...Object.fromEntries(
    MY_CAREER_HUBS.map((h) => [
      h.icao,
      { lat: h.lat, lon: h.lon, name: h.name },
    ]),
  ),
  ...
  ...Object.fromEntries(
    CN_CAREER_HUBS.map((h) => [
      h.icao,
      { lat: h.lat, lon: h.lon, name: h.name },
    ]),
  ),
  ...Object.fromEntries(
    JP_CAREER_HUBS.map((h) => [
      h.icao,
      { lat: h.lat, lon: h.lon, name: h.name },
    ]),
  ),
  ...
  ...Object.fromEntries(
    FJ_CAREER_HUBS.map((h) => [
      h.icao,
      { lat: h.lat, lon: h.lon, name: h.name },
    ]),
  ),
  ...Object.fromEntries(
    PG_CAREER_HUBS.map((h) => [
      h.icao,
      { lat: h.lat, lon: h.lon, name: h.name },
    ]),
  ),
...
export function createSeedEconomyWorld(opts: { seed?: string } = {}): CareerEconomyWorld {
  ...
  world.internationalLanes = selectDynamicInternationalLanes(world);
  return world;
}
...
function* formLotsFromImbalances(
  ...
  const tryFormPair = (
    ...
    if (
      ...
      const smallRangeMaxNm = opts.international
        ? INTL_LIGHT_JET_LTL_MAX_NM
        : SMALL_LOT_MAX_NM;
      const inSmallRange =
        nm != null && nm >= LAST_MILE_MIN_NM && nm <= smallRangeMaxNm;
      const canFormGa =
