# FenixA321 IAE WF TC — discovery

**In-sim title (example):** `FenixA321 IAE WF TC`  
**Match title:** `FenixA321 IAE WF TC`  
**ICAO (SimBrief type):** `A321`  
**Publisher:** `fenix`  
**Stations:** 16  
**Profile:** `fenix/fenixa321-iae-wf-tc@1.0.0`
...
- `profiles/examples/fenix-fenixa321-iae-wf-tc.json`
