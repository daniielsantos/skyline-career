...
describe('career-runways catalog', () => {
  it('covers every network career hub with at least one runway', () => {
    ...
    for (const icao of ['GMMN', 'HEBA', 'LLER', 'DAAG', 'DTTA', 'SBGR', 'OEJN', 'OMDB', 'OTHH', 'OKKK', 'OETF', 'ORBI', 'ORMM', 'OIIE', 'OJAI', 'OLBA', 'OSDI', 'HLLM', 'HSSK', 'OYSN', 'OYAA', 'OPIS', 'OPKC', 'VIDP', 'VABB', 'VOBL', 'VOMM', 'VECC', 'VCBI', 'VCRI', 'UAAA', 'UTTT', 'UTAA', 'UATE'] as const) {
