...
- **Port FBO (2026-09-06):** Phase 0–6 shipped — lease-out **off**; Port FBO desk; stevedore; Base slim; bonded holds off; **company crew off**. Base = parking/Jet-A/MRO. Spec: [`24-port-fbo.md`](./24-port-fbo.md).
