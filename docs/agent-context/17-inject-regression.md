...
- **Bonanza SimBrief ICAO:** SKU pistão A36/A36TC → live **BE36** / **BT36** (mesmo Market SKU). B36TP é SKU `light_turboprop` separado → **B36T**. Live TP com Lab pistão **não** troca o ICAO p/ B36T (preflight rejeita).
