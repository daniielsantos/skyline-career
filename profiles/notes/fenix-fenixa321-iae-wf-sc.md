# FenixA321 IAE WF SC — discovery

**In-sim title (example):** `FenixA321 IAE WF SC`  
**Match title:** `FenixA321 IAE WF SC`  
**ICAO (SimBrief type):** `A321`  
**Publisher:** `fenix`  
**Stations:** 16  
**Profile:** `fenix/fenixa321-iae-wf-sc@1.0.0`
...
- `profiles/examples/fenix-fenixa321-iae-wf-sc.json`
