# ATR 42-600 Stol � discovery

**In-sim title (example):** `ATR 42-600 Stol`  
**Match title:** `ATR 42-600 Stol`  
**ICAO (SimBrief type):** `AT46`  
**Publisher:** `microsoft`  
**Stations:** 11  
**Profile:** `microsoft/atr-42-600-stol@1.0.0`
...
- `profiles/examples/microsoft-atr-42-600-stol.json`
